...
[![SDK Version](https://img.shields.io/badge/latestVersion-0.0.7-informational.svg)](https://stuff.mit.edu/afs/sipb/project/android/docs/reference/packages.html)
...
```kotlin
dependencies {
  implementation : 'com.github.Tap-Payments:BenefitPay-Android:0.0.7'
}
```
